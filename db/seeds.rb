...
transaction1 = Transaction.create(user_id: '1',loyaltyProgram_id: targetfrequent.id, item_bought: '778399',price: '5.67',qty_bought: '2',coupon_id: '7756661')
transaction2 = Transaction.create(user_id: '1',loyaltyProgram_id: targetfrequent.id, item_bought: '1134',price: '78.9',qty_bought: '6',coupon_id: '88891')
transaction3 = Transaction.create(user_id: '4',loyaltyProgram_id: containerfrequent.id, item_bought: '13390099',price: '105.76',qty_bought: '1',coupon_id: '57146')
transaction4 = Transaction.create(user_id: '3',loyaltyProgram_id: cvssaver.id, item_bought: '6772108',price: '56.78',qty_bought: '10',coupon_id: coupon1.id)
transaction5 = Transaction.create(user_id: '5',loyaltyProgram_id: walgreensfriend.id, item_bought: '8872231',price: '7.45',qty_bought: '3',coupon_id: '5561')
